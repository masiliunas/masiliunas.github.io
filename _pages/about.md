...
- Theory-driven research questions:
  ...
  -  If there are mutiple equilibria (conventions), how can can a group move from a bad equilibrium to a better one, and how to design the game to facilitate such efficiency-enhancing transitions?

- Policy-driven reserach questions:
  - Are concentrated markets more collusive, and why?
  - How does exposure to economic inequality affect the movitation to work, cheat, invest in future growth, solve problems of the future generations? How to mitigate the negative effects of inequlity using redistribution and feedback?
  - How to design international agreements for climate change mitigation? 



I am interested in how decisions are adapted over time and how the adaptation process is affected by the environment. Topics covered in my work include complexity in games, bounded rationality, inefficient conventions, strategic teaching and learning.
